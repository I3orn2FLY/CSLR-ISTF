...
# Source dataset, uncomment PH for Phoenix dataset.
SOURCE = "PH"
# SOURCE = "KRSL"

vars_prefix = os.sep.join([VARS_DIR, SOURCE])
...
VIDEOS_DIR = os.path.join(GEN_DATA_DIR, "END2END_VIDEOS")
...
IMG_FEAT_DIR = os.sep.join([GEN_DATA_DIR, "IMG_FEATS", STF_MODEL])
...
TF_MODEL_PATH = os.sep.join([WEIGHTS_DIR, STF_MODEL, str(IMG_FEAT_SIZE), "TF_" + load_crit + ".pt"])
